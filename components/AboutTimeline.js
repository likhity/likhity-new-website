  ...
  return (
    <Timeline>
      <Timeline.Left start={true} timeText="Early 2016">
        <h3 className='h1 mb-4'>The <span className='code'>HTML</span> &amp; <span className="code">CSS</span> Days</h3>
      ...
      <Timeline.Right timeText="Summer 2016">
        <h3 className='h1 mb-4'>The Unity &amp; <span className="code">C#</span> Days</h3>
      ...
      <Timeline.Left timeText="Fall 2019">
        <h3 className='h1 mb-4'>The <span className="code">Processing</span> Days</h3>
      ...
      <Timeline.Left timeText="Summer 2020">
        <h3 className='h1 mb-4'>The <span className="code">Python</span> Days</h3>
      ...
      <Timeline.Right timeText="Fall 2020">
        <h3 className='h1 mb-4'>The <span className="code">p5.js</span> Days</h3>
      ...
      <Timeline.Right timeText="2021 - 2022">
        <h3 className='h1 mb-4'>The <span className="code">C</span> &amp; <span className="code">C++</span> Days</h3>
