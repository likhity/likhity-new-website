  ...
  return (
    <Timeline>
      <Timeline.Left start={true} timeText="Early 2016">
        <h3 className='h1 mb-4'>Learning <span className='code'>HTML</span> &amp; <span className="code">CSS</span></h3>
      ...
      <Timeline.Right timeText="Summer 2016">
        <h3 className='h1 mb-4'>Learning Unity &amp; <span className="code">C#</span></h3>
      ...
      <Timeline.Left timeText="Fall 2019">
        <h3 className='h1 mb-4'>Learning <span className="code">Processing</span></h3>
      ...
      <Timeline.Left timeText="Summer 2020">
        <h3 className='h1 mb-4'>Learning <span className="code">Python</span></h3>
      ...
      <Timeline.Right timeText="Fall 2020">
        <h3 className='h1 mb-4'>Learning <span className="code">p5.js</span></h3>
